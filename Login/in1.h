              ...
              <div class="signin-container">
                  ...
                  <form id="signin-form">
                      ...
                      <div class="options-container">
                          ...
                          <a href="http://13.221.233.193:8116/">Forgot Password?</a>
                      </div>

                      <button type="submit">Sign In</button>
                  </form>

                  <p style="text-align: center;">Don't have an account? <a href="http://13.221.233.193:8118/">Sign Up</a></p>
              </div>
          </div>
      </div>
      ...
      <script>
          document.addEventListener('DOMContentLoaded', function () {
              ...
              form.addEventListener('submit', async function (event) {
                  ...
                  try {
                      const response = await fetch('http://13.221.233.193:3081/api/login', {
                          method: 'POST',
